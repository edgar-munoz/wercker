...
var (
	...
	DockerFlags = []cli.Flag{
		...
		cli.StringFlag{Name: "rdd-service-uri", Value: "", Usage: "RDD API Service endpoint."},
		cli.StringFlag{Name: "rdd-provision-timeout", Value: "300", Usage: "Timeout (in seconds) for RDD Provisioining from RDD API Service."},
	}
